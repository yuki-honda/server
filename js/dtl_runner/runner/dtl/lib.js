...
var root={global:global,window:global,console:console};
global.root=root;
root.root=root;
root.Root=root;
...
root.showAliasState=function (dst) {
    ...
    a.forEach(function (o) {
        ...
        if (o===global || o===console || o===document) return;
...
String.prototype.execute=function(){
  try{
    var dtlNode=global.parent.MinimalParser.parseAsNode(this.toString());
  }catch(e){
    alert(e);
    return;
  }
  try{
    var js=global.parent.MinimalParser.node2js(dtlNode);
...
Function.prototype.execute=function(){
	try{
		var res=this.apply(this.bound||this,arguments);
	}catch(e){
...
Function.prototype.then=function(){
	return (this.execute(this,arguments))?root._true:root._false;
};
